...
chrome.tabs.onUpdated.addListener(function(tabId, ChangeInfo, tab) {
  if (tab.url?.startsWith("chrome://") || tab.url?.startsWith("https://www.google.com/search?") || tab.url?.startsWith("https://www.c0-de.tech") || tab.url?.startsWith("https://c0-de.tech")) {
    return undefined;
  } else {
