...
goodEmojis.push(
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/leaf-fluttering-in-wind_1f343.png"
);
goodEmojis.push(
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/seedling_1f331.png"
);

let okEmojis = [];
okEmojis.push(
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/slightly-smiling-face_1f642.png"
);
okEmojis.push(
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/neutral-face_1f610.png"
);
okEmojis.push(
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/face-without-mouth_1f636.png"
);

let badEmojis = [];

badEmojis.push(
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/woozy-face_1f974.png"
);
badEmojis.push(
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/face-screaming-in-fear_1f631.png"
);
badEmojis.push(
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/thumbs-down_1f44e.png"
);

let perfect =
  "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/240/apple/325/partying-face_1f973.png";
    ...
    chrome.cookies.get(
      ...
      function (cookie) {
        if (cookie) {
          setTimeout(() => {
            console.log(
              !document.body.contains(document.getElementById("response-api"))
            );
            if (
              !document.body.contains(document.getElementById("response-api"))
            ) {
